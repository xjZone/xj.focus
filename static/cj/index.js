...
if(hashValue === ''){
	var LastScrollLeft = xjls.get('xj_focus_index_LastScrollLeft');
	var LastScrollTop  = xjls.get('xj_focus_index_LastScrollTop' );
...
jqi_win.on('scroll hashchange', function(){
	...
	scrollTimeout01 = setTimeout(function(){
		xjls.set('xj_focus_index_LastScrollLeft', jqi_win.scrollLeft());
		xjls.set('xj_focus_index_LastScrollTop',  jqi_win.scrollTop() );
	}, 250);
});
